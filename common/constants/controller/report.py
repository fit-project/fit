...
DESCRIPTION = (
    "FIT - Freezing Internet Tool è un’applicazione per l'acquisizione forense di contenuti "
...
T3DESCR = (
    "Nel corso dell'acquisizione, l'utente navigava alcuni siti web. FIT "
...
T4DESCR = (
    "La digital forensics è l'applicazione scientifica e tecnologica dei principi "
...
TITLEH = "Hash"
HDESCR = (
    "L'hash delle prove digitali è un valore univoco che rappresenta i dati "
...
T5DESCR = (
    "Durante l'acquisizione, il sistema ha prodotto una serie di file "
...
T6DESCR = (
    "Ogni file prodotto dall'infrastruttura viene validato mediante il calcolo degli hash. "
...
T7DESCR = (
    "Tutti i file prodotti dall'utente durante l'acquisizione sono raccolti all'interno "
...
VERIFI_OK = (
    "La verifica del timestamp del report in formato PDF ha fornito esito positivo. "
...
VERIFI_KO = (
    "La verifica del timestamp del report in formato PDF ha fornito esito negativo. "
    "Di seguito vengono riportate le informazioni riguardanti l'esito della verifica, il file, "
    "l'algoritmo di hashing e il servizio di Time Stamp Authority utilizzato per effettuare il controllo."
)
