...
class NetworkCheck(QtWidgets.QGroupBox):
    ...
    def initUI(self):
        ...
        self.group_box_nslookup_configuration.setGeometry(
            QtCore.QRect(280, 30, 371, 51)
        )
        self.group_box_nslookup_configuration.setObjectName(
            "group_box_nslookup_configuration"
        )

        # NSLOOKUP DNS SERVER
        self.nslookup_dns_server = QtWidgets.QLineEdit(
            self.group_box_nslookup_configuration
        )
    ...
    def __set_current_config_values(self):
        ...
        self.nslookup_enable_verbose_mode.setChecked(
            self.configuration["nslookup_enable_verbose_mode"]
        )
