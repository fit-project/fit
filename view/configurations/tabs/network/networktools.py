...
class NetworkTools(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        self.headers_checkbox = QtWidgets.QCheckBox(
        ...
        self.traceroute_checkbox = QtWidgets.QCheckBox(
            parent=self.enable_network_tools_box
        )
