...
class General(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        self.tool_button_cases_folder = QtWidgets.QToolButton(
            self.group_box_cases_folder
        )
        ...
        self.label_user_agent_site = ClickableLabelView(
            general.USER_AGENT_SITE, self.group_box_user_agent
        )
        ...
        self.button_default_user_agent = QtWidgets.QToolButton(
            self.group_box_user_agent
        )
