...
class CaseForm(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        self.case_form_layout.setWidget(6, QtWidgets.QFormLayout.ItemRole.LabelRole, self.logo_label)
        ...
        self.case_form_layout.setWidget(6, QtWidgets.QFormLayout.ItemRole.FieldRole, logo_widget)

        # NOTES
        self.notes_label = QtWidgets.QLabel(self)
        self.notes_label.setFont(font)
        self.notes_label.setObjectName("notes_label")
        self.case_form_layout.setWidget(7, QtWidgets.QFormLayout.ItemRole.LabelRole, self.notes_label)
        self.notes = QtWidgets.QTextEdit(self)
        self.notes.setAlignment(QtCore.Qt.AlignmentFlag.AlignTop)
        self.notes.setFont(font)
        self.notes.setObjectName("notes")
        self.case_form_layout.setWidget(7, QtWidgets.QFormLayout.ItemRole.FieldRole, self.notes)

        self.retranslateUi()
    def __select_logo(self):
        file_name, _ = QFileDialog.getOpenFileName(self, "Seleziona immagine", "",
